...
export default class ShineChartCell extends Component {
  constructor(props) {
    super(props);
    this.state={
      attention:null,
  ...
  componentDidMount(){
    this.setState({
      numPraise:parseInt(this.props.data.dynamic.praises) ,
      attention:this.props.data.user.attention_type,
      comments:this.props.data.dynamic.omments,
      praise:this.props.data.dynamic.ispraise,
  ...
  return(
    <View style={styles.cellItem}>
      <TouchableOpacity>
        ...
        >
          {
            this.state.pics.map((item,i) => {
              return(
              <TouchableHighlight onPress={() => this._onBannerItemClickCallback(item)} key={i}>
               <Image style={{width:theme.screenWidth-20,height:theme.screenWidth-20}} source={{uri:item.url}}/>
              </TouchableHighlight>
            );
            })
          }
        ...
        {/* <Image style={{width:theme.screenWidth - 20,height:180,marginLeft:10,marginRight:10,marginTop:10}} source={{uri:this.props.data.middle_pic_url}}/> */}
        ...
        <View style={styles.bottom}>
          <View style={styles.bottom_left}>
            ...
            <View style={styles.bottom_item}>
                ...
                <Text style={styles.numText}>{this.props.data.dynamic.omments}</Text>
            </View>
          ...
          <Text style={{color:'#BFBFBF',fontSize:13,marginRight:10}}>{this.props.data.dynamic.views +  ' 浏览'}</Text>
        </View>
