...
import ExpertListView from '../ListView/expertListView';
  ...
  render(){
    return(
      <View style={styles.container}>
        <CommonNavBar title='达人排行榜' needBack={true} backOnPress={() => MainPage.pageBack(this)} />
        <ScrollableTabView
                       ...
                       {tabNames.map((item, i) => {
                           return(
                              <ExpertListView tabLabel={item} id={i} sortType={i} key={i}/>
                           );
                       })
                     }
         </ScrollableTabView>
