...
import ShineChartListView from '../ListView/shineListView';
  ...
  render(){
    return(
      <View style={styles.container}>
        <CommonNavBar title='晒单排行榜' needBack={true} backOnPress={() => MainPage.pageBack(this)}/>
        <ScrollableTabView
                       ...
                       {tabNames.map((item, i) => {
                           return(
                              <ShineChartListView tabLabel={item} id={i} sortType={i} key={i}/>
                           );
                       })
                     }
         </ScrollableTabView>
